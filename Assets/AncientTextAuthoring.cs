...
public static class AncientTextAuthoring
{
    ...
    {
        "lust", "greed", "desire", "anger", "envy", "ego"
    };
    ...
    private static List<AncientTextData> BuildBaseline()
    {
        ...
        // Greed
        list.Add(MakeText("text_greed_act1_01", "The Hunger at Dawn", "We woke to a table that had not been set. We ate what the tide had not yet claimed. The hunger never left; it only learned new names."));
        ...
        list.Add(MakeText("text_desire_act2_01", "Drowsy Watch", "The watch fell asleep at the third bell. By the fifth, the rift was twice as wide. We do not blame the watch; the bell was heavy."));
        list.Add(MakeText("text_desire_act3_01", "Footfalls", "Our steps are faster now. The island is almost through with us. We will not be drowsy at the end."));

        // Anger
        list.Add(MakeText("text_anger_act1_01", "Kindled Edge", "The first blow felt like sunrise. By the third it felt like weather. We mistook the heat for the cause, and the cause for the cure."));
        list.Add(MakeText("text_anger_act2_01", "Furnace Hour", "The forge does not care whose temper it cools. We learned to swing before we learned to listen. The island heard us anyway."));
        list.Add(MakeText("text_anger_act3_01", "Ashen Calm", "The fires on the island are out. The party is quieter. The cost of being heard was everything we had to shout with."));
        ...
        // Ego
        list.Add(MakeText("text_ego_act1_01", "The High Step", "We crossed the threshold of the final island before the rest. The island was patient. We were not."));
        list.Add(MakeText("text_ego_act2_01", "Unasked Counsel", "We had advice for the tide, the trees, and the low sky. The island nodded at each. None of it altered."));
        list.Add(MakeText("text_ego_act3_01", "Lowered Head", "Before the rift we stood tall. After the conversation we did not. The island had not asked us to bow; it had only asked us to listen."));
